...
function OpenLink(url, title = '', subtitle = '', data = '', container = 1) {
  ...
  "Error!": "Erro!",
  "Nice ;)":"Legal ;)",
  "You have 0 notifications":"Você não tem notificações",
  "Edit":"Editar",
  "Mural":"Mural",
  "Properties":"Imóveis",
  "CRM":"CRM",
  ...
  "Add a new property":"Adicionar um novo imóvel",
  "New appointment":"Nova visita",
  "New customer":"Novo cliente",
  "Leads":"Leads",
  "Customers":"Clientes",
  "Appointments":"Visitas",
  "New dealing":"Nova negociação",
  "Dealings":"Negociações",
  "Using":"Usando",
  "Unauthorized!": "Acesso negado!",
  "You don't have permissions to access this page": " Você não tem permissão para acessar essa página",
  "An error occurred while trying to access this function, please try again later or contact us.": "Ocorreu um erro ao tentar acessar essa função, por favor tente novamente mais tarde ou entre em contato conosco"
